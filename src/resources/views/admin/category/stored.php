<?php
    ...
    if (isset($_GET['key'])) {
        $key = $_GET['key'];
        $sql = "SELECT * FROM category WHERE name LIKE '%$key%' OR id LIKE '%$key%'";
                        ...
                        if ($query) {
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td>" . $row['slug'] . "</td>
                                    <td>
                                        <a href='/watch-shop/src/resources/views/admin/category/edit.php?id=" . $row['id'] . "' class='btn btn-primary' type='submit'>Sửa</a>
                                    </td>
                                    <td>
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    btnDelete.onclick = function () {
                        deleteForm.action = '/watch-shop/src/resources/views/admin/category/delete.php?id=' + id;
                        deleteForm.submit();
                    }
                });
            </script>
