<?php
    ...
    if (isset($_GET['key'])) {
        $key = $_GET['key'];
        $sql = "SELECT * FROM account WHERE email LIKE '%$key%' OR id LIKE '%$key%'";
                        ...
                        if ($query) {
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td>" . $row['logoutAt'] . "</td>
                                    <td>
                                        <a href='/watch-shop/src/resources/views/admin/account/customer.php?id=" . $row['id'] . "' class='btn btn-primary' type='submit'>Chi tiết</a>
                                    </td>
                                    <td>
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    btnDelete.onclick = function () {
                        deleteForm.action = '/watch-shop/src/resources/views/admin/account/delete.php?id=' + id;
                        deleteForm.submit();
                    }
                });
            </script>
